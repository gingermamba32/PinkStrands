...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Oregon Pink Hair Extensions</title>
        <meta name="keywords" content="Oregon pink hair extensions, pink hair, pink strands for cause, pink hair strands in Oregon" />
        <meta name="description" content="Find a salon in Oregon to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Oregon</h1>
                ...
                <p style="font-size:14px;">
                    Escape Tanning and Salon<br/>
                    1003 E Jackson St.<br/>
                    Medford, OR 97504<br/>
                    Phone: 541-618-5255<br/>
                    Email: <a href="mailto:Kayleeselee@yahoo.com">Kayleeselee@yahoo.com</a>
                </p>            <!-- Start Map-->
                <div align="center">
