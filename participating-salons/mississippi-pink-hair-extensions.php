...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Mississippi Pink Hair Extensions</title>
        <meta name="keywords" content="Mississippi pink hair extensions, pink hair, pink strands for cause, pink hair strands in Mississippi" />
        <meta name="description" content="Find a salon in Mississippi to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Mississippi</h1>
                ...
                <p style="font-size:14px;">
                    Salon-Hair Express<br/>
                    706 D Hwy 12 W.<br/>
                    Starkville, MS 39759<br/>
                    Phone: 662-320-4444<br/>
                    Email: <a href="mailto:claire_eaves@yahoo.com">claire_eaves@yahoo.com</a>
                </p>
                <p style="font-size:14px;">
                    Belk Salon and Spa<br/>
                    1000 Turtle Creek Drive<br/>
                    Hattiesburg, MS 39402<br/>
                    Phone: 601-268-6156<br/>
                    Email: <a href="mailto:Lauranellg@Yahoo.com">Lauranellg@Yahoo.com</a>
                </p>
                <p style="font-size:14px;">
                    Belk Salon and Spa<br/>
                    1000 Turtle Creek Drive<br/>
                ...
                <p style="font-size:14px;">
                    En Vogue Salon<br/>
                    Robb Roy<br/>
                    1002 Telephone Road,<br/>
                    Pascagoula, MS 39567<br/>
                    Phone (Robb): 228-363-5236<br/>
                    Phone (Salon): 228-769-8000<br/>
                    Email: <a href="mailto:Lauranellg@Yahoo.com">rob3rtroy@gmail.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
