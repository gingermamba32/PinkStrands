...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Washington Pink Hair Extensions</title>
        <meta name="keywords" content="Washington pink hair extensions, pink hair, pink strands for cause, pink hair strands in Washington" />
        <meta name="description" content="Find a salon in Washington to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Washington</h1>
                ...
                <p style="font-size:14px;">
                    My Hair Day with Jessica<br/>
                    Bothell, WA<br/>
                    Phone: 360-561-0132<br/>
                    Email: <a href="mailto:Jessica@myhairday.com">Jessica@myhairday.com</a>
                </p>
                <p style="font-size:14px;">
                    Hair Solutions<br/>
                    Angela Rood <br>
                    1112 E Front street<br>
                    Port Angeles, WA. 98362<br/>
                    Phone: 360-477-1639<br/>
                    Email: <a href="mailto:angela_lavonne@hotmail.com">angela_lavonne@hotmail.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
