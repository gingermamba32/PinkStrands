...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - South Dakota Pink Hair Extensions</title>
        <meta name="keywords" content="South Dakota pink hair extensions, pink hair, pink strands for cause, pink hair strands in South Dakota" />
        <meta name="description" content="Find a salon in South Dakota to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in South Dakota</h1>
