...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Illinois Pink Hair Extensions</title>
        <meta name="keywords" content="Illinois pink hair extensions, pink hair, pink strands for cause, pink hair strands in Illinois" />
        <meta name="description" content="Find a salon in Illinois to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Illinois</h1>
                ...
                <p style="font-size:14px;">
                    Hair With Us<br/>
                    151 N Evergreen Ave.<br/>
                    Arlington Heights, IL 60004<br/>
                    Phone: 847-253-2011<br/>
                    Email: <a href="mailto:HairWithUs@gmail.com">HairWithUs@gmail.com</a>
                </p>
                <p style="font-size:14px;">
                    Appearances Salon<br/>
                    7603 W. North Ave<br/>
                    River Forest, IL 60305<br/>
                    Phone: 708-209-1505<br/>
                    Email: <a href="mailto:appearancessalon@ymail.com">appearancessalon@ymail.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
