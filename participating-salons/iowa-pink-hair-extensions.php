...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Iowa Pink Hair Extensions</title>
        <meta name="keywords" content="Iowa pink hair extensions, pink hair, pink strands for cause, pink hair strands in Iowa" />
        <meta name="description" content="Find a salon in Iowa to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Iowa</h1>
                ...
                <p style="font-size:14px;">
                    The Cutting Edge - Lynn Withers<br/>
                    518 Front Street<br/>
                    Sioux Rapids, IA 50585<br/>
                    Phone: 712-283-2093<br/>
                    Email: <a href="mailto:scrappygirl@webbwireless.net">scrappygirl@webbwireless.net</a>
                </p>
                <p style="font-size:14px;">
                    Cut Loose<br/>
                    410 West 17th Street<br/>
                    Tama, IA 52339<br/>
                    Phone: 641-481-1512<br/>
                    Email: <a href="mailto:Krazehair@icloud.com">Krazehair@icloud.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
