...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - New Hampshire Pink Hair Extensions</title>
        <meta name="keywords" content="New Hampshire pink hair extensions, pink hair, pink strands for cause, pink hair strands in New Hampshire" />
        <meta name="description" content="Find a salon in New Hampshire to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in New Hampshire</h1>
