...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Tennessee Pink Hair Extensions</title>
        <meta name="keywords" content="Tennessee pink hair extensions, pink hair, pink strands for cause, pink hair strands in Tennessee" />
        <meta name="description" content="Find a salon in Tennessee to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Tennessee</h1>
                ...
                <p style="font-size:14px;">
                    Hair Affair<br/>
                    1385 South Highland Ave.<br/>
                    Jackson, TN 38301<br/>
                    Phone: 731-423-0333<br/>
                    Email: <a href="mailto:danettewebb@gmail.com">danettewebb@gmail.com</a>
                </p>
                <p style="font-size:14px;">
                    Sophsitikutz Salon<br/>
                    515 West Elk Ave<br/>
                    Elizabethton, TN 37643<br/>
                    Phone: 423-833-6605<br/>
                    Email: <a href="mailto:alishaderr@charter.net">alishaderr@charter.net</a>
                </p>
                <p style="font-size:14px;">
                    David Alan Salon<br/>
                    Stephanie Harrison<br>
                    6900 Lenox Village Drive<br/>
                    Nashville, TN 37211<br/>
                    Phone: 615-401-9767<br/>
                    Email: <a href="mailto:davidalansalon@icloud.com">davidalansalon@icloud.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
