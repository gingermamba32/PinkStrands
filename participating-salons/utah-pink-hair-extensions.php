...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Utah Pink Hair Extensions</title>
        <meta name="keywords" content="utah pink hair extensions, pink hair, pink strands for cause, pink hair strands in Utah" />
        <meta name="description" content="Find a salon in Utah to get your pink hair extension installed for a $10 donation towards breast cancer awareness" />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Utah</h1>
                ...
                <p style="font-size:14px;">
                    Element Salon - Julie Ryan<br/>
                    1103 south Orem Blvd<br/>
                    Orem, UT 84058<br/>
                    Phone: 801-473-1571<br/>
                    Email: <a href="mailto:Julie@elementsalon.com">Julie@elementsalon.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
