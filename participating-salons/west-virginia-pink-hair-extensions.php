...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - West Virginia Pink Hair Extensions</title>
        <meta name="keywords" content="West Virginia pink hair extensions, pink hair, pink strands for cause, pink hair strands in West Virginia" />
        <meta name="description" content="Find a salon in West Virginia to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in West Virginia</h1>
                ...
                <p style="font-size:14px;">
                    Harner Hair Company<br/>
                    2712 Camden Avenue<br/>
                    Parkersburg, WV 26101<br/>
                    Phone: 304-424-7405<br/>
                    Email: <a href="mailto:katieharner@hotmail.com">katieharner@hotmail.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
