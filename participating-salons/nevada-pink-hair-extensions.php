...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Nevada Pink Hair Extensions</title>
        <meta name="keywords" content="Nevada pink hair extensions, pink hair, pink strands for cause, pink hair strands in Nevada" />
        <meta name="description" content="Find a salon in Nevada to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Nevada</h1>
                ...
                <p style="font-size:14px;">
                    Belle Cheveux Salon - McCall Hancock<br/>
                    3645 S. TownCenter Drive, Suite 105<br/>
                    Las Vegas, NV 89135<br/>
                    Phone: 702-880-6300<br/>
                    Email: <a href="mailto:Mccallhancock@gmail.com">Mccallhancock@gmail.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
