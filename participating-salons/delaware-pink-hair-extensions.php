...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Delaware Pink Hair Extensions</title>
        <meta name="keywords" content="Delaware pink hair extensions, pink hair, pink strands for cause, pink hair strands in Delaware" />
        <meta name="description" content="Find a salon in Delaware to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Delaware</h1>
                ...
                <p style="font-size:14px;">
                    CMP Designs Salon<br/>
                    1601 N. Lincoln St.<br/>
                    Wilmington, DE 19806<br/>
                    Phone: 302-379-5328<br/>
                    Email: <a href="mailto:ches1vtec@yahoo.com">ches1vtec@yahoo.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
