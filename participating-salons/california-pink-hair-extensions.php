...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - California Pink Hair Extensions</title>
        <meta name="keywords" content="California pink hair extensions, pink hair, pink strands for cause, pink hair strands in California" />
        <meta name="description" content="Find a salon in California to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in California</h1>
                ...
                <p style="font-size:14px;">
                    Xcyphr Hair Studio<br/>
                    2218 Golden Avenue<br/>
                    San Bernardino, CA 92404<br/>
                    Phone: 909-474-9336<br/>
                    Email: <a href="mailto:xcyphr@yahoo.com">xcyphr@yahoo.com</a>
                </p>
                <p style="font-size:14px;">
                    The Hair Republic<br/>
                    14976 Foothill Blvd. Ste. 700<br/>
                    Fontana, CA 92335<br/>
                    Phone: 909-260-6468<br/>
                    Email: <a href="mailto:cjslabon@aol.com">cjslabon@aol.com</a>
                </p>
                <p style="font-size:14px;">
                    All Dahled Up<br/>
                    6045 Pineland Ave.<br/>
                    San Jose, CA 95123<br/>
                    Phone: 408-612-2270<br/>
                    Email: <a href="mailto:Alldahledup@yahoo.com">Alldahledup@yahoo.com</a>
                </p>
                 <p style="font-size:14px;">
                    Katie Petersen<br/>
                    BlowPop Dry Bar <br/>
                    ...
                    Phone: 619-241-2569<br/>
                    Email: <a href="mailto:katie@blowpopdrybar.com">katie@blowpopdrybar.com</a>
                </p>
                <p style="font-size:14px;">
                    Sandra Hartman<br/>
                    Bon Chic Hair Studio <br/>
                    2220 J st Ste 4 <br/>
                    Sacramento, CA 85816<br/>
                    Phone: 916-441-6536<br/>
                    Email: <a href="mailto:katie@blowpopdrybar.com">Cassandra198870@yahoo.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
