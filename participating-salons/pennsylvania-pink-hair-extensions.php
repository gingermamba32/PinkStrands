...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Pennsylvania Pink Hair Extensions</title>
        <meta name="keywords" content="Pennsylvania pink hair extensions, pink hair, pink strands for cause, pink hair strands in Pennsylvania" />
        <meta name="description" content="Find a salon in Pennsylvania to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Pennsylvania</h1>
                ...
                <p style="font-size:14px;">
                    Metro Beauty Academy<br/>
                    4977 Medical Center Cir<br/>
                    Allentown, PA 18106<br/>
                    Phone: 610-398-6227<br/>
                    Email: <a href="mailto:lminnich@metrobeautyacademy.com">lminnich@metrobeautyacademy.com</a>
                </p>
                <p style="font-size:14px;">
                    Hair Naturale<br/>
                    5758 Route 115<br/>
                    Blakeslee, PA 18610<br/>
                    Phone: 570-643-5095<br/>
                    Email: <a href="mailto:dianeramsey06@icloud.com">dianeramsey06@icloud.com</a>
                </p>
                <p style="font-size:14px;">
                    Blue Lotus Salon<br/>
                    1091 General Knox Road<br/>
                    Washington Crossing, PA 18977<br/>
                    Phone: 215-493-0616<br/>
                    Email: <a href="mailto:thebluelotussalon@gmail.com">thebluelotussalon@gmail.com</a>
                </p>
                <p style="font-size:14px;">
                    Salon Taboo<br/>
                    6518 Rt 22, Suite 434<br/>
                    Delmont, PA 15626<br/>
                    Phone: 724-461-7458<br/>
                    Email: <a href="mailto:Salontaboo@yahoo.com">Salontaboo@yahoo.com</a>
                </p>
                <p style="font-size:14px;">
                    Salon G'onna<br/>
                    100 Swiss Lane<br/>
                    Elizabeth, PA 15037<br/>
                    Phone:  412-769-9602<br/>
                    Email: <a href="mailto:lminnich@metrobeautyacademy.com">guads999@yahoo.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
