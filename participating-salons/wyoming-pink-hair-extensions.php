...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Wyoming Pink Hair Extensions</title>
        <meta name="keywords" content="Wyoming pink hair extensions, pink hair, pink strands for cause, pink hair strands in Wyoming" />
        <meta name="description" content="Find a salon in Wyoming to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Wyoming</h1>
                ...
                <p style="font-size:14px;">
                    Sunrise Images Salon<br/>
                    4330 South Poplar<br/>
                    Casper, WY 82601<br/>
                    Phone: 307-265-2252<br/>
                    Email: <a href="mailto:sunriseimagessalon@bresnan.net">sunriseimagessalon@bresnan.net</a>
                </p>
                <!-- Start Map-->
                <div align="center">
