...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Washington D.C. Pink Hair Extensions</title>
        <meta name="keywords" content="Washington D.C. pink hair extensions, pink hair, pink strands for cause, pink hair strands in Washington D.C." />
        <meta name="description" content="Find a salon in Washington D.C. to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Washington D.C.</h1>
                ...
                <h2><u>Salons</u></h2>
                <p>Unfortunately, there are no participating salons in your area at this time. Please continue checking back as we are constantly adding new salons to carry and install our pink strand hair extensions.</p>
                <!-- Start Map-->
                <div align="center">
