...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Louisiana Pink Hair Extensions</title>
        <meta name="keywords" content="Louisiana pink hair extensions, pink hair, pink strands for cause, pink hair strands in Louisiana" />
        <meta name="description" content="Find a salon in Louisiana to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Louisiana</h1>
                ...
                <p style="font-size:14px;">
                    Cabello Hair Studio<br/>
                    2922 Knight Street<br/>
                    Shreveport, LA 71107<br/>
                    Phone: 318-868-4000<br/>
                    Email: <a href="mailto:Robbiemeshell@me.com">Robbiemeshell@me.com</a>
                </p>
                <p style="font-size:14px;">
                    Kressin Cuts & Color<br/>
                    308 Maple St.<br/>
                    Janesville, LA 50647<br/>
                    Phone: 319-269-3220<br/>
                    Email: <a href="mailto:alexisjk23@hotmail.com">alexisjk23@hotmail.com</a>
                </p>
                <!-- Start Map-->
                <!-- Start Map-->
                <div align="center">
