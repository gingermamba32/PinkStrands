...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Rhode Island Pink Hair Extensions</title>
        <meta name="keywords" content="Rhode Island pink hair extensions, pink hair, pink strands for cause, pink hair strands in Rhode Island" />
        <meta name="description" content="Find a salon in Rhode Island to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Rhode Island</h1>
