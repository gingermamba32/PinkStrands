...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Kansas Pink Hair Extensions</title>
        <meta name="keywords" content="Kansas pink hair extensions, pink hair, pink strands for cause, pink hair strands in Kansas" />
        <meta name="description" content="Find a salon in Kansas to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Kansas</h1>
                ...
                <p style="font-size:14px;">
                    Kristie Denham<br/>
                    la Bella Vita Hair Studio<br/>
                    918 Massachusetts, Suite B<br/>
                    Lawrence, KS 66044<br/>
                    Phone: 785-727-0170<br/>
                </p>
                <!-- Start Map-->
                <div align="center">
