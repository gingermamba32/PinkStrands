...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Pink Strands For The Cause - Missouri Pink Hair Extensions</title>
        <meta name="keywords" content="Missouri pink hair extensions, pink hair, pink strands for cause, pink hair strands in Missouri" />
        <meta name="description" content="Find a salon in Missouri to get your pink hair extension installed for a $10 donation towards breast cancer awareness." />
    ...
    <body id="home_body">
        <div id="site_wrapper">
            ...
            <div style="margin-top:5px;">
                <h1>Participating Pink Strand Salons in Missouri</h1>
                ...
                <p style="font-size:14px;">
                    Latter Rain Salon and Spa<br/>
                    1460 E Cherry St<br/>
                    Springfield, MO 65804<br/>
                    Phone: 417-719-4273<br/>
                    Email: <a href="mailto:latterraincherry@gmail.com">latterraincherry@gmail.com</a>
                </p>
                <p style="font-size:14px;">
                    Rish Design @ Araby Salon<br/>
                    406 East 18th Street<br/>
                    Kansas City, MO 64108<br/>
                    Phone: 816-785-5363<br/>
                    Email: <a href="mailto:lindsey@rishdesign.net">lindsey@rishdesign.net</a>
                </p>
                <p style="font-size:14px;">
                    R salon<br/>
                    Krystal Spencer </br>
                    127 S Buchanan<br/>
                    Maryville, MO 64487<br/>
                    Email: <a href="mailto:lindsey@rishdesign.net">Krystallinn.ks@gmail.com</a>
                </p>
                <!-- Start Map-->
                <div align="center">
